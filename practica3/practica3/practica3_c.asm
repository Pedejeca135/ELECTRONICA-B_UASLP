 ...
 *   Author: pjco9
 objetivo:
 Implemente un programa en ensamblador AVR el cual utilice dos push-button (eliminar
rebotes por hardware) para aumentar/disminuir en una unidad un dígito mostrado por las
puntas de prueba. El número mostrado deberá estar codificado en complemento a dos, y
podrá representar números negativos.
 */ 
