 ...
 *   Author: pjco9
 ...
 objetivo:
Implemente un programa en ensamblador AVR el cual lea un dato de 4 bits por el puerto
C (pines A0-A3), cada vez que se presione un push-button (eliminar los rebotes por
hardware) muestre el dato en un display de 7 segmentos por el puerto D (pines 0 a 7). El
dato se ingresará en binario por medio del dipswitch y se deberá mostrar en decimal en
el display. (Manejar valores en hexadecimal dentro del programa).
